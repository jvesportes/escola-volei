              ...
              <div className="flex flex-col items-center gap-4">
                <div className="flex flex-col gap-2 items-center">
                  ...
                  <p className="subtle text-center">
                    Nosso compromisso com a integridade é inabalável. Agimos com
                    honestidade, transparência e ética em tudo o que fazemos,
                    buscando sempre a verdade e mantendo altos padrões morais.
                  </p>
                </div>
            ...
            <Card className="md:p-6 p-4 gap-2 md:min-w-[300px] min-w-[230px]">
              <div className="flex flex-col items-center gap-4">
                <div className="flex flex-col gap-2 items-center">
                  ...
                  <p className="subtle text-center">
                    Abraçamos a inovação como motor de progresso. Constantemente
                    buscamos maneiras criativas de melhorar e encontrar soluções
                    para desafios complexos, impulsionando o crescimento e a
                    evolução.
                  </p>
                </div>
              ...
              <div className="flex flex-col items-center gap-4">
                <div className="flex flex-col gap-2 items-center">
                  ...
                  <p className="subtle text-center">
                    ...
                    Trabalhamos lado a lado, apoiando e cuidando uns dos outros,
                    e também contribuindo para o bem-estar das comunidades em
                    que vivemos e atuamos.
                  </p>
                </div>
