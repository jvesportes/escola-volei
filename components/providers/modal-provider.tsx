...
} from '../modals/alunos/pagamentos/excluir-pagamento-aluno-modal';
import {
  PagamentoAlunoModal,
} from '../modals/alunos/pagamentos/pagamento-aluno-modal';
...
} from '../modals/professor/excluir-professor-modal';
...
} from '../modals/turmas/turma/excluir-turma-modal';
import {
  HistoricoModal,
} from '../modals/turmas/turma/historico/historico-modal';
import {
  ExcluirAlunoListaEsperaModal,
} from '../modals/turmas/turma/lista-espera/excluir-lista-espera-modal';
import {
  ListaEsperaModal,
} from '../modals/turmas/turma/lista-espera/lista-espera-modal';
